...
# https://github.com/exercism/problem-specifications/tree/main/exercises/proverb_func/canonical-data.json
...
class ProverbTest(unittest.TestCase):
    def test_zero_pieces(self):
        input_data = []
        self.assertEqual(proverb_func(*input_data, qualifier=None), [])

    def test_one_piece(self):
        input_data = ["nail"]
        self.assertEqual(
            proverb_func(*input_data, qualifier=None), ["And all for the want of a nail."]
        )

    def test_two_pieces(self):
        input_data = ["nail", "shoe"]
        self.assertEqual(
            proverb_func(*input_data, qualifier=None),
            [
    ...
    def test_an_optional_qualifier_can_be_added(self):
        input_data = ["nail"]
        self.assertEqual(
            proverb_func(*input_data, qualifier="horseshoe"),
